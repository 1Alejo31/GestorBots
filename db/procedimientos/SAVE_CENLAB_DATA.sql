...
DROP PROCEDURE IF EXISTS SAVE_CENLAB_DATA //
...
BEGIN
    ...
    -- Handler debe declararse ANTES de cualquier sentencia ejecutable
    ...
    IF EMPRESA IS NULL THEN
        -- No continuamos con el INSERT si no existe empresa
        ROLLBACK;
        SET V_CODIGO = '1';
